...
class ViewController: UIViewController {
    ...
    let futureArray = ["What would you like to be doing a month from now?","What would you like to be doing 2 weeks from now?","What would you like to be doing a year from now?"]
    ...
    func randomNumberGenerator(){
        ...
        textField.font =  UIFont(name: "HelveticaNeue-UltraLight", size: 100)
